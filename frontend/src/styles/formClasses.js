...
export const FORM_PRIMARY_BUTTON_DISABLED_CLASS = `${FORM_PRIMARY_BUTTON_CLASS} disabled:cursor-not-allowed disabled:bg-gray-300 disabled:text-gray-500 disabled:shadow-none disabled:opacity-100 dark:disabled:bg-gray-700 dark:disabled:text-gray-400`;

export const FORM_COMPACT_PRIMARY_BUTTON_DISABLED_CLASS =
  "rounded-md bg-purple-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-purple-700 disabled:cursor-not-allowed disabled:bg-gray-300 disabled:text-gray-500 dark:bg-purple-500 dark:hover:bg-purple-400 dark:disabled:bg-gray-700 dark:disabled:text-gray-400";
